...
public class LoadHistoryDetailTask extends WSClientSyncTask {

	private String technicianId;

	public LoadHistoryDetailTask(WSRequest request, String technicianId) {
		super(request);
	...
	protected void onPostExecute(WSResponse result) {
		...
		if (result == null) {
			...
			resp_intent
					.setAction(Const.WS_RESPONSE_ACTIONS.WS_LOAD_PROPERTY_HISTORY_SUCCESS);
			// resp_intent.putExtra("response", result);
		}
