...
public class LoadPropertyTask extends WSClientSyncTask {

	private String technicianId;

	// upload photo
	public LoadPropertyTask(WSRequest request, String technicianId) {
		super(request);
	...
	protected void onPostExecute(WSResponse result) {
		...
		if (Const.DEBUG) {
			...
			resp_intent.setAction(Const.WS_RESPONSE_ACTIONS.WS_LOAD_PROPERTY_SUCCESS);
